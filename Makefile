...
mkvirtualenv: ## create the project environment
	@python3 -m venv "$$WORKON_HOME/Speakers-Verification"
	@. "$$WORKON_HOME/Speakers-Verification/bin/activate"
	@pip install --upgrade pip setuptools wheel

mkvirtualenv-system: ## create the project environment with system site packages
	@python3 -m venv "$$WORKON_HOME/Speakers-Verification" --system-site-packages
	@. "$$WORKON_HOME/Speakers-Verification/bin/activate"
	@pip install --upgrade pip setuptools wheel
